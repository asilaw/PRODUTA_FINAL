# Capacity Planning — FIS analysis view
...
from modules.financial_calc import (compute_financial, capex_multiline,
    capex_new_line, capex_stickpack_line, DEFAULT_PARAMS, MACHINES)

try:
    from modules.fis_engine import compute_fis
except ImportError:
    def compute_fis(util_max, unmet_ratio, finished_ratio):
        # Fallback if skfuzzy unavailable
        score = util_max * 0.4 + unmet_ratio * 0.4 + (1 - finished_ratio) * 0.2
